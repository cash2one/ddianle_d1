...
{
    -- 宠物类型      宠物潜质(参见Excel配置)
	{ petTypeID = 1, potential = 1, announce = false, rate = 800},
	{ petTypeID = 1, potential = 2, announce = false, rate = 150},
	{ petTypeID = 1, potential = 3, announce = false, rate = 50},
	{ petTypeID = 2, potential = 1, announce = false, rate = 800},
	{ petTypeID = 2, potential = 2, announce = false, rate = 150},
	{ petTypeID = 2, potential = 3, announce = false, rate = 50},
	{ petTypeID = 3, potential = 1, announce = false, rate = 800},
	{ petTypeID = 3, potential = 2, announce = false, rate = 150},
	{ petTypeID = 3, potential = 3, announce = false, rate = 50},
	{ petTypeID = 4, potential = 1, announce = false, rate = 800},
	{ petTypeID = 4, potential = 2, announce = false, rate = 150},
	{ petTypeID = 4, potential = 3, announce = false, rate = 50},
	{ petTypeID = 5, potential = 1, announce = false, rate = 800},
	{ petTypeID = 5, potential = 2, announce = false, rate = 150},
	{ petTypeID = 5, potential = 3, announce = false, rate = 50},
