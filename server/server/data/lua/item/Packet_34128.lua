...
-------------------以下是一个礼包的定义
--礼品包的详细信息
function GetPacketItemsInfo_34128(RoleIndex, PacketID)
...
-- 礼包定义,需要填物品ID号,数量
function PacketGetReward_34128 (RoleIndex)
	local nPacketID = 34128
	local Sex = GetRoleSex(RoleIndex)
	--礼包的道具数量,必填
	local Count = 3
	local ItemTable = {}
...
--注册获取礼包信息函数
-- 礼包ID 礼包描述函数
RegisterGetPacketInfo(34128, GetPacketItemsInfo_34128)
--注册礼包使用函数
--                    礼包ID 礼包获取函数
RegisterGetPacketItem(34128, PacketGetReward_34128)
