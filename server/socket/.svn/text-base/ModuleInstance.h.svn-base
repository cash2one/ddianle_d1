...
public:
	...
	virtual BOOL PopulateProcesses() = 0;
protected:
...
public:
	...
	virtual BOOL PopulateProcesses();
private:
	HMODULE                 m_hModPSAPI;
...
{
public:
	CExeModuleInstance(char *pszName, HMODULE hModule, DWORD dwProcessId);
	virtual ~CExeModuleInstance();
	// Returns process id
	DWORD Get_ProcessId() const;
	BOOL PopulateModules(CLibHandler* pLibHandler);
	DWORD GetModuleCount() const;
